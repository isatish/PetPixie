...
namespace Merial.PetPixie.Core.Views
{
    public partial class ImageButton : ContentView
    {
        ...
        public FileImageSource Source
        {
            ...
            set
            {
                ...
                LoadContents(this.Source.File, 1, 1);
            }
        }
        ...
        public ImageButton(DiscoverItemViewModel vm, FeedModel likeContext, string imageSource, int likeImageNumber)
        {
            InitializeComponent();
   ...
   //         ((DiscoverItemViewModel)BindingContext).ShowProfileCommand.Execute(image2);
        ...
        public void LoadContents(string imageSource,  int numberOfLikes, int likeImageNumber)
        {
