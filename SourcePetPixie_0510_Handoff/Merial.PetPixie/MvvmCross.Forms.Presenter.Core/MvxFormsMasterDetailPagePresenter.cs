...
namespace MvvmCross.Forms.Presenter.Core
{
    ...
    public abstract class MvxFormsMasterDetailPagePresenter : MvxViewPresenter
    {
        ...
        {
            var page = MvxPresenterHelpersCheese.CreatePage(request);
            if (page == null)
                return false;

            var viewModel = MvxPresenterHelpersCheese.LoadViewModel(request);            
            ...
            if (mainPage == null)
            {
                ...
                if (masterDetailViewModel.RootContentPageViewModelType != null)
                {
                    ...
                    var rootContentViewModel = MvxPresenterHelpersCheese.LoadViewModel(rootContentRequest);
                    rootContentPage = MvxPresenterHelpersCheese.CreatePage(rootContentRequest);
